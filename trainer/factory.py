from trainer.generator import demand_generator, irradiance_generator, temperature_generator, wind_speed_generator
...
def factory(seeds, size):
    ...
    df.to_csv('dados.csv')
    Console.send_debug('Data from factory saved to dados.csv')
    return selections    
